...
class SlotsControllerTest < ActionController::TestCase
  ...
  test "should create slot" do
    assert_difference('Slot.count') do
      post :create, slot: { doctor_id: @slot.doctor_id, hospital_id: @slot.hospital_id, slot_duration: @slot.slot_duration, slot_shift: @slot.slot_shift }
    end
  ...
  test "should update slot" do
    patch :update, id: @slot, slot: { doctor_id: @slot.doctor_id, hospital_id: @slot.hospital_id, slot_duration: @slot.slot_duration, slot_shift: @slot.slot_shift }
    assert_redirected_to slot_path(assigns(:slot))
  end
