...
Doctor.create(first_name: 'Venkatesh',last_name: 'Reddy',age:'35',sex:true,qualification:'MBBS',speciality:'Dentist',rating:4)
Doctor.create(first_name: 'Ajay',last_name: 'Kumar',age:'45',sex:true,qualification:'MBBS',speciality:'Dentist',rating:4)
Doctor.create(first_name: 'K.K.',last_name: 'Sinha',age:'52',sex:true,qualification:'MBBS',speciality:'Dentist',rating:4)
